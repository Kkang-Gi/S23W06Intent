package kr.ac.kumoh.ce.s20210025.s23w06intent
...
import kr.ac.kumoh.ce.s20210025.s23w06intent.ui.theme.S23W06IntentTheme
...
fun Greeting(name: String, modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Button(
            ...
            onClick = {
                val uri =
                    Uri.parse("geo:0,0?q=경상남도 창원시 성산구 반송로 105")
                val intent = Intent(Intent.ACTION_VIEW, uri)
                startActivity(context, intent, null)
            }
        ) {
